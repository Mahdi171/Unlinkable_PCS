...
class UPCS():
    ...
    def RandKey(self,mpk,sk):
        ...
        Final={}; c_x={}; R={}; c_a=[]; c_b=[]; X_Bridge={}; Pi_Bridge={}
        ...
        x = (cm2, GS_comY[idx][1], pp_com['G'], pp_com['H'], group.init(G1,1),\
             C_P[1], mpk['CRS1']['vv2'][1], mpk['CRS1']['ww2'][1])
        pi = Sigma.D_Bridging.Prove(self.Sigma,x,w)
    ...
    def Sign(self,mpk,sk,pk_R,mes):
        ...
        NIZK.Batched_verify(self,pp,mpk['CRS1'],pk_R['pi'],pk_R['comX'],pk_R['comY'],mpk['LT1']) and \
            ...
            x = (cm2, GS_comX[idx][1], pp_com['G'], pp_com['H'], group.init(G1,1),\
