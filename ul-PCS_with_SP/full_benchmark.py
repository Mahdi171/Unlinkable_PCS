...
class Full_benchmark(): 
    ...
    def main(self,n_R,iter):
        ...
        file = open("/app/SP/parameters/SPmsk_{}.txt".format(n_R), "w") 
        str = repr(serializeObject(msk,group))
        file.write(str)
        file.close()
        result.append(os.path.getsize("/app/SP/parameters/SPmsk_{}.txt".format(n_R))/1000)
        
        
        file = open("/app/SP/parameters/SPmpk_{}.txt".format(n_R), "w") 
        str = repr(serializeObject(mpk,group))
        file.write(str)
        file.close()
        result.append(os.path.getsize("/app/SP/parameters/SPmpk_{}.txt".format(n_R))/1000)
        pk={};sk={}
        ...
        file = open("/app/SP/parameters/SPsk_{}.txt".format(n_R), "w") 
        str = repr(serializeObject(sk,group))
        file.write(str)
        file.close()
        result.append(os.path.getsize("/app/SP/parameters/SPsk_{}.txt".format(n_R))/1000)
        
        file = open("/app/SP/parameters/SPpk_{}.txt".format(n_R), "w") 
        str = repr(pk)
        file.write(str)
        file.close()
        result.append(os.path.getsize("/app/SP/parameters/SPpk_{}.txt".format(n_R))/1000)
        ...
        file = open("/app/SP/parameters/SPSig_{}.txt".format(n_R), "w")
        file.write(repr(sigma))
        file.close()
        result.append(os.path.getsize("/app/SP/parameters/SPSig_{}.txt".format(n_R))/1000)
